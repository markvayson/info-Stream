...
function Header() {
  return (
    <header className="z-50 fixed top-0 left-0 right-0 justify-center items-center bg-gray-100  border-b border-gray-200 dark:border-gray-700  dark:bg-gray-800  flex flex-col">
